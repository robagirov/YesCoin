...
export const getUsers = (options?: SecondParameter<typeof axiosInstance>, signal?: AbortSignal) => {
  return axiosInstance<UserRead[]>({ url: `https://yestoken.space/users`, method: 'GET', signal }, options)
}
 ...
 */
export const updateUserInfo = (userUpdate: UserUpdate, options?: SecondParameter<typeof axiosInstance>) => {
  return axiosInstance<UserUpdate>(
    { url: `https://yestoken.space/users`, method: 'PUT', headers: { 'Content-Type': 'application/json' }, data: userUpdate },
    options,
  )
}

export const getUpdateUserInfoMutationOptions = <TError = HTTPValidationError, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof updateUserInfo>>, TError, { data: UserUpdate }, TContext>
  request?: SecondParameter<typeof axiosInstance>
 ...
 * @summary Update User Info
 */
export const useUpdateUserInfo = <TError = HTTPValidationError, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof updateUserInfo>>, TError, { data: UserUpdate }, TContext>
  request?: SecondParameter<typeof axiosInstance>
}) => {
 ...
 * @summary Add User
 */
export const addUser = (userCreate: UserCreate, options?: SecondParameter<typeof axiosInstance>) => {
  return axiosInstance<UserCreate>(
    { url: `https://yestoken.space/users`, method: 'POST', headers: { 'Content-Type': 'application/json' }, data: userCreate },
    options,
  )
}

export const getAddUserMutationOptions = <TError = HTTPValidationError, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof addUser>>, TError, { data: UserCreate }, TContext>
  request?: SecondParameter<typeof axiosInstance>
 ...
 * @summary Add User
 */
export const useAddUser = <TError = HTTPValidationError, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof addUser>>, TError, { data: UserCreate }, TContext>
  request?: SecondParameter<typeof axiosInstance>
}) => {
 ...
 * @summary Get User
 */
export const getUser = (userId: number, options?: SecondParameter<typeof axiosInstance>, signal?: AbortSignal) => {
  return axiosInstance<UserRead>({ url: `https://yestoken.space/users/${userId}`, method: 'GET', signal }, options)
}
...
export const getGetUserQueryOptions = <TData = Awaited<ReturnType<typeof getUser>>, TError = HTTPValidationError>(
  userId: number,
  options?: {
...
export const tap = (params: TapParams, options?: SecondParameter<typeof axiosInstance>) => {
  return axiosInstance<UserTap>({ url: `https://yestoken.space/users/tap`, method: 'PUT', params }, options)
}

export const getTapMutationOptions = <TError = HTTPValidationError, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof tap>>, TError, { params: TapParams }, TContext>
  request?: SecondParameter<typeof axiosInstance>
 ...
 * @summary Get Squads
 */
export const getSquads = (options?: SecondParameter<typeof axiosInstance>, signal?: AbortSignal) => {
  return axiosInstance<SquadRead[]>({ url: `https://yestoken.space/squads`, method: 'GET', signal }, options)
}
...
export const getGetSquadsQueryOptions = <TData = Awaited<ReturnType<typeof getSquads>>, TError = unknown>(options?: {
  ...
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof getSquads>>, TError, TData> & {
    queryKey: QueryKey
  }
}
 ...
 * @summary Get Squads
 */
export const useGetSquads = <TData = Awaited<ReturnType<typeof getSquads>>, TError = unknown>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getSquads>>, TError, TData>>
  request?: SecondParameter<typeof axiosInstance>
}): UseQueryResult<TData, TError> & { queryKey: QueryKey } => {
 ...
 * @summary Get Leagues
 */
export const getLeagues = (options?: SecondParameter<typeof axiosInstance>, signal?: AbortSignal) => {
  return axiosInstance<LeagueRead[]>({ url: `https://yestoken.space/leagues`, method: 'GET', signal }, options)
}
...
export const getGetLeaguesQueryOptions = <TData = Awaited<ReturnType<typeof getLeagues>>, TError = unknown>(options?: {
  ...
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof getLeagues>>, TError, TData> & {
    queryKey: QueryKey
  }
}
 ...
 * @summary Get Leagues
 */
export const useGetLeagues = <TData = Awaited<ReturnType<typeof getLeagues>>, TError = unknown>(options?: {
  query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getLeagues>>, TError, TData>>
  request?: SecondParameter<typeof axiosInstance>
}): UseQueryResult<TData, TError> & { queryKey: QueryKey } => {
 ...
 * @summary Add League
 */
export const addLeague = (leagueCreate: LeagueCreate, options?: SecondParameter<typeof axiosInstance>) => {
...
export const getAddLeagueMutationOptions = <TError = HTTPValidationError, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<Awaited<ReturnType<typeof addLeague>>, TError, { data: LeagueCreate }, TContext>
  request?: SecondParameter<typeof axiosInstance>
